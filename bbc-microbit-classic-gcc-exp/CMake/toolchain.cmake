...
set(MERGE_SCRIPT_LOCATION "${CMAKE_CURRENT_LIST_DIR}/../python/merge_hex.py")
...
function(yotta_apply_target_rules target_type target_name)
    if(${target_type} STREQUAL "EXECUTABLE")
        add_custom_command(TARGET ${target_name}
            ...
            COMMAND python ${MERGE_SCRIPT_LOCATION} ${NRF51822_BOOTLOADER_HEX_FILE} ${NRF51822_SOFTDEVICE_HEX_FILE} ${target_name}.hex -o ${target_name}-combined.hex
